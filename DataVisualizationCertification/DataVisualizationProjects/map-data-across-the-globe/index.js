...
function handleZoom () {
  mapPos.x = d3.event.transform.x
  mapPos.y = d3.event.transform.y
  mapPos.zoom = d3.event.transform.k

  svg.attr('transform', `translate(${mapPos.x}, ${mapPos.y}) scale(${mapPos.zoom})`)
}
